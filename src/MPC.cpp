...
using CppAD::AD;
    ...
    class FG_eval {
        ...
        void operator()(ADvector& fg, const ADvector& vars) {
             ...
             * NOTE: You'll probably go back and forth between this function
             * and the Solver function below.
             */
            ...
            /*
             * add the cost based on reference state
             */
            for (int t = 0; t < N; t++) {
             ...
             */
            for (int t = 0; t < N - 2; t++) {
                fg[0] += 500*CppAD::pow(vars[delta_start + t + 1] -
             ...
             * Setup Constraints
             *
             * NOTE: This section will setup the model constraints.
             *
             * Initial constraints
             * We add 1 to each of the starting indices due to cost being
             * located at index 0 of `fg`. This bumps up the position of
...
vector<double> MPC::Solve(Eigen::VectorXd state, Eigen::VectorXd coeffs) {
    ...
    /*
     * Initial value of the independent variables. SHOULD BE 0 besides initial
     * state.
     */
    Dvector vars(n_vars);
   ...
   */
    ...
    /*
     * set the constrains for initial state
     */
    ...
    vector<double> predicted_state;

    /*
     * Saved the actuator commands, delta and a
     */
    predicted_state.push_back(solution.x[delta_start]);
    predicted_state.push_back(solution.x[a_start]);

    for (int t = 1; t < N; t++) {
        predicted_state.push_back(solution.x[x_start + t]);
        predicted_state.push_back(solution.x[y_start + t]);
    }
